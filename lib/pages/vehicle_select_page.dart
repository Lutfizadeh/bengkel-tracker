...
class _VehicleSelectPageState extends State<VehicleSelectPage> {
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed:
                mainVehicle == null
                    ? null
                    : () => Navigator.pop(context, mainVehicle),
            ...
            child: Text(
              mainVehicle == null
                  ...
                  : 'Gunakan ${mainVehicle.title} (Utama)',
              textAlign: TextAlign.center,
              style: const TextStyle(
                fontSize: 14.5,
                fontWeight: FontWeight.w700,
  ...
  Widget _vehicleCard(Vehicle vehicle) => Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(
        color: vehicle.isMain ? AppColors.orange : AppColors.warmBorder,
        width: vehicle.isMain ? 1.8 : 1,
      ),
      boxShadow: appShadow,
    ),
    child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color:
                        vehicle.isMain ? AppColors.orange : Colors.transparent,
                    border: Border.all(
                      color:
                          vehicle.isMain
                              ? AppColors.orange
  ...
  String _vehicleAsset(String type) {
    ...
    if (type == 'Truk/Bus') return AppAssets.truck;
